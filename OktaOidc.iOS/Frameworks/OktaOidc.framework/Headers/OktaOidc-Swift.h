...
- (BOOL)resume:(NSURL * _Nonnull)url options:(NSDictionary<UIApplicationOpenURLOptionsKey, id> * _Nonnull)options SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,obsoleted=11.0,message="Unused on iOS 11+");
...
- (nonnull instancetype)initWithAuthState:(OIDAuthState * _Nonnull)authState accessibility:(CFStringRef _Nonnull)accessibility OBJC_DESIGNATED_INITIALIZER;
...
+ (NSString * _Nonnull)userAgentHeader SWIFT_WARN_UNUSED_RESULT;
